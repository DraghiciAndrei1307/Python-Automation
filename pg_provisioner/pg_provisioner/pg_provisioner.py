...
class PgProvisioner:
    ...
    def start_pg_vm_provisioning(self):
        ...
        result = self.os_runner.run_cmd(
            input_command='ansible-playbook -i /home/student/PostgreSQL-Ansible-Automation/ansible/inventories/ /home/student/PostgreSQL-Ansible-Automation/ansible/provision_postgresql_VM.yml',
